...
const WHATSAPP_NUMBER = "5582993132265"; // Substituir pelo número real
      ...
      <div className="container">
        <div className={`${styles.wrapper} ${isVisible ? styles.visible : ""}`}>
          ...
          <p className={styles.subtitle}>
            Solicite uma proposta sem compromisso e descubra como a Nutriday
            pode cuidar da alimentação da sua empresa.
          </p>
